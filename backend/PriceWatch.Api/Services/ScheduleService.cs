...
public sealed class ScheduleService
{
    ...
    public async Task<ScheduleStatus>
        GetAsync()
    {
        var taskExists =
            await TaskExistsAsync();
        ...
        )
    {
        ...
        ))
        {
            throw new InvalidOperationException(
                $"Scraper not found: {scraperPath}"
            );
        }


        var pythonExecutable =
            await FindPythonExecutableAsync();
        ...
        // Avoid an unnecessary second PowerShell query here.
        return new ScheduleStatus(
            TaskExists:
                true,
    ...
    private static string QuotePowerShell(
        string value
    )
    {
        return
